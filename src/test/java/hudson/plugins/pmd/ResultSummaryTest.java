...
public class ResultSummaryTest extends AbstractEnglishLocaleTest {
    ...
    public void test0WarningsIn0File() {
        checkSummaryText(0, 0, "PMD: 0 warnings from 0 PMD analyses.");
    }
    ...
    public void test0WarningsIn1File() {
        checkSummaryText(0, 1, "PMD: 0 warnings from one PMD analysis.");
    }
    ...
    public void test0WarningsIn5analyses() {
        checkSummaryText(0, 5, "PMD: 0 warnings from 5 PMD analyses.");
    }
    ...
    public void test1WarningIn2analyses() {
        checkSummaryText(1, 2, "PMD: <a href=\"pmdResult\">1 warning</a> from 2 PMD analyses.");
    }
    ...
    public void test5WarningsIn1File() {
        checkSummaryText(5, 1, "PMD: <a href=\"pmdResult\">5 warnings</a> from one PMD analysis.");
    }
